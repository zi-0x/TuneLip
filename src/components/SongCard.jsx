...
const SongCard = ({ song, isPlaying, activeSong , i , data}) => {
  ...
  <div className="relative w-full h-56 group">
    <div className={`absolute inset-0 justify-center items-center bg-black bg-opacity-30 group-hover:flex ${activeSong?.attributes.name === song?.attributes.name ? 'flex bg-black bg-opacity-80' : 'hidden'} `}>
     <PlayPause 
        isPlaying= {isPlaying}
